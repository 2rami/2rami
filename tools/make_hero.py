...
# 리드미에서 이 창은 이름표(585) 오른쪽에 선다. 마크다운이 그림 사이에 넣는
# 4px 를 빼면 남는 폭이 257 이고, 높이는 이름표와 같은 188 이라야 두 덩이의
# 아랫변이 한 줄에 선다. 전에는 240x190 을 리드미에서 257 로 늘려 걸어서
# 도트가 1.07 배로 뭉개지고 아랫변도 15px 어긋났다(2026-08-27).
W, H = 257, 188
BAR = 22           # 제목줄 높이
CYCLE = 9.0        # 한 바퀴(초)
